...
Ideally this application was originally intended to be a Rails App.  The functionality of this application would support the utilization of a users camera to scan a food labels list of ingredients, as well as provide a user updates to remember their epi-pen and renew their epi-pen prescription. If you are interested in contributing to this project please contact the author for further instruction.
...
Please complete the following procedure to run the program on a live system:
  ...
  3. Then run the commands `$ git clone https://github.com/kteich88/B-Safe.git` and `$ cd B-Safe`
